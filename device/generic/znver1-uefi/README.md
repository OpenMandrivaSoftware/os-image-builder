# Installing OpenMandriva Lx on znver1 hardware with UEFI support
To install OpenMandriva Lx on znver1 hardware with UEFI support
...
$ cd /mnt
$ sudo tar xf ~/Downloads/boot-znver1-uefi.tar.xz
...
$ cd /mnt
$ sudo tar xf ~/Downloads/rootfs-znver1-uefi.tar.xz
$ cd
$ sudo umount /mnt
$ sudo eject /dev/sdb
$ sudo sync
